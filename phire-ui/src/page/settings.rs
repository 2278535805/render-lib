...
impl GeneralList {
    pub fn new(icon_lang: SafeTexture) -> Self {
        Self {
            ...
            mp_addr_input: InlineInputBtn::new(false, false),
...
impl OtherList {
    pub fn new() -> Self {
        Self {
            ...
            watermark_input: InlineInputBtn::new(false, false),
            combo_input: InlineInputBtn::new(false, false),
            ...
            #[cfg(feature = "play")]
            health_mode_input: InlineInputBtn::new(true, false),
        }
    }
